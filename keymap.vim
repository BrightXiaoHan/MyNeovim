...
nnoremap <silent><space>' :vs +term<CR>:vert res30<CR>
" adjustment window size vertically
...
nnoremap <silent><space>" :sp +term<CR>:res30<CR>
" adjustment window size horizentally
